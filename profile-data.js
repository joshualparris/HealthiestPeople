window.PROFILE_CONFIG = {
  "joshua-parris": {
    ...
    researchNote: "../document.html?src=docs/people/joshua-parris.md",
    fullArchive: "../health-archive.html",
    spotlights: [
    ...
    library: [
      {kind:"Research notes",title:"Joshua Parris comparison profile",url:"../document.html?src=docs/people/joshua-parris.md",note:"The source-by-source comparison profile used by this website."},
      {kind:"Longitudinal archive",title:"Full health archive",url:"../document.html?src=docs/people/joshua-parris-full-health-archive.md",note:"The larger source-specific longitudinal archive."},
  ...
  "bryan-johnson": {
    ...
    researchNote: "../document.html?src=docs/people/bryan-johnson.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/bryan-johnson.md",note:"The project's detailed evidence-aware profile."}
    ]
  },
  "michael-lustgarten": {
    ...
    researchNote: "../document.html?src=docs/people/michael-lustgarten.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/michael-lustgarten.md",note:"Detailed profile and limitations."}
    ]
  },
  "oskar-svendsen": {
    ...
    researchNote: "../document.html?src=docs/people/oskar-svendsen.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/oskar-svendsen.md",note:"Detailed physiology, controversy and transferability notes."}
    ]
  },
  "dave-pascoe": {
    ...
    researchNote: "../document.html?src=docs/people/dave-pascoe.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/dave-pascoe.md",note:"Detailed profile with cost and transferability context."}
    ]
  },
  "scott-kelly": {
    ...
    researchNote: "../document.html?src=docs/people/scott-kelly.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/scott-kelly.md",note:"Detailed physiological findings and ordinary-life lessons."}
    ]
  },
  "julie-gibson-clark": {
    ...
    researchNote: "../document.html?src=docs/people/julie-gibson-clark.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/julie-gibson-clark.md",note:"Detailed context and cautions."}
    ]
  },
  "bob-troia": {
    ...
    researchNote: "../document.html?src=docs/people/bob-troia.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/bob-troia.md",note:"Detailed N-of-1 examples and limitations."}
    ]
  },
  "michael-snyder": {
    ...
    researchNote: "../document.html?src=docs/people/michael-snyder.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/michael-snyder.md",note:"Detailed metabolic chronology and transferability notes."}
    ]
  },
  "larry-smarr": {
    ...
    researchNote: "../document.html?src=docs/people/larry-smarr.md",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?src=docs/people/larry-smarr.md",note:"Detailed chronology, evidence grades and cautions."}
    ]
  }
};

window.PROFILE_CONFIG = {
  "joshua-parris": {
    ...
    researchNote: "../document.html?doc=people/joshua-parris",
    ...
    library: [
      {kind:"Research notes",title:"Joshua Parris comparison profile",url:"../document.html?doc=people/joshua-parris",note:"The source-by-source comparison profile used by this website."},
      {kind:"Longitudinal archive",title:"Full health archive",url:"../document.html?doc=people/joshua-parris-full-health-archive",note:"The larger source-specific longitudinal archive."},
  ...
  "bryan-johnson": {
    ...
    researchNote: "../document.html?doc=people/bryan-johnson",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/bryan-johnson",note:"The project's detailed evidence-aware profile."}
    ]
  },
  "michael-lustgarten": {
    ...
    researchNote: "../document.html?doc=people/michael-lustgarten",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/michael-lustgarten",note:"Detailed profile and limitations."}
    ]
  },
  "oskar-svendsen": {
    ...
    researchNote: "../document.html?doc=people/oskar-svendsen",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/oskar-svendsen",note:"Detailed physiology, controversy and transferability notes."}
    ]
  },
  "dave-pascoe": {
    ...
    researchNote: "../document.html?doc=people/dave-pascoe",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/dave-pascoe",note:"Detailed profile with cost and transferability context."}
    ]
  },
  "scott-kelly": {
    ...
    researchNote: "../document.html?doc=people/scott-kelly",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/scott-kelly",note:"Detailed physiological findings and ordinary-life lessons."}
    ]
  },
  "julie-gibson-clark": {
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/julie-gibson-clark",note:"Detailed context and cautions."}
    ]
  },
  "bob-troia": {
    ...
    researchNote: "../document.html?doc=people/bob-troia",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/bob-troia",note:"Detailed N-of-1 examples and limitations."}
    ]
  },
  "michael-snyder": {
    ...
    researchNote: "../document.html?doc=people/michael-snyder",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/michael-snyder",note:"Detailed metabolic chronology and transferability notes."}
    ]
  },
  "larry-smarr": {
    ...
    researchNote: "../document.html?doc=people/larry-smarr",
    spotlights: [
    ...
    library: [
      ...
      {kind:"Research notes",title:"Full project research note",url:"../document.html?doc=people/larry-smarr",note:"Detailed chronology, evidence grades and cautions."}
    ]
  }
};
